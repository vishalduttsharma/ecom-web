...
export default function Faq() {
  return (
   <>
   <Breadcrum title="Frequenty Asked Questions" description="Find quick answers to common questions about orders, payments, delivery, and returns at Heritageally. We’re here to make your shopping experience simple and hassle-free."/>
